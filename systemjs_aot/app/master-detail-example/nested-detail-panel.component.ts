import { NestedDetail2PanelComponent } from './nested-detail2-panel.component';
...
@Component({
    ...
    templateUrl: 'nested-detail-panel.component.html'
})
export class NestedDetailPanelComponent implements ICellRendererAngularComp, AfterViewInit {
    ...
    public getFullWidthCellRenderer1() {
        return NestedDetail2PanelComponent;
    }    

    public getRowHeight(params) {
        var rowIsDetailRow = params.node.level === 1;        
        return rowIsDetailRow ? 300 : 30;
    }
