    ...
    FromRichComponent.prototype.createColumnDefs = function () {
        return [
            { headerName: "Name", field: "name", width: 200 },
            {
                ...
                field: "ratios",
                cellRenderer: this.agComponentFactory.createCellRendererFromComponent(ratio_parent_component_1.RatioParentComponent, this._viewContainerRef, [ratio_component_1.RatioComponent]),
                width: 200
            },
            {
                headerName: "Clickable Component",
                field: "name",
                cellRenderer: this.agComponentFactory.createCellRendererFromComponent(clickable_parent_component_1.ClickableParentComponent, this._viewContainerRef, [clickable_component_1.ClickableComponent]),
                width: 200
            }
        ];
    };
