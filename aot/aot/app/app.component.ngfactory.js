...
var _View_AppComponent0 = (function (_super) {
    ...
    _View_AppComponent0.prototype.createInternal = function (rootSelector) {
        ...
        this._el_0 = import4.createRenderElement(this.renderer, parentRenderNode, 'ul', new import4.InlineArray2(2, 'class', 'nav nav-pills'), null);
        ...
        this._el_5 = import4.createRenderElement(this.renderer, parentRenderNode, 'router-outlet', import4.EMPTY_INLINE_ARRAY, null);
        this._appEl_5 = new import3.AppElement(5, null, this, this._el_5);
        this._RouterOutlet_5_5 = new import13.Wrapper_RouterOutlet(this.parentInjector.get(import16.RouterOutletMap), this._appEl_5.vcRef, this.parentInjector.get(import17.ComponentFactoryResolver), null);
...
var _View_AppComponent2 = (function (_super) {
    ...
    _View_AppComponent2.prototype._handle_click_2_0 = function ($event) {
