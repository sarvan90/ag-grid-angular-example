...
export var View_AppComponent0 = (function (_super) {
    ...
    View_AppComponent0.prototype.createInternal = function (rootSelector) {
        ...
        this._el_0 = import3.createRenderElement(this.renderer, parentRenderNode, 'ul', new import3.InlineArray2(2, 'class', 'nav nav-pills'), null);
        ...
        this._vc_5 = new import10.ViewContainer(5, null, this, this._el_5);
        this._RouterOutlet_5_5 = new import12.Wrapper_RouterOutlet(this.parentView.injectorGet(import15.RouterOutletMap, this.parentIndex), this._vc_5.vcRef, this.parentView.injectorGet(import16.ComponentFactoryResolver, this.parentIndex), null);
    ...
    View_AppComponent0.prototype.injectorGetInternal = function (token, requestNodeIndex, notFoundResult) {
        ...
        if (((token === import18.RouterOutlet) && (5 === requestNodeIndex))) {
...
var View_AppComponent1 = (function (_super) {
    ...
    View_AppComponent1.prototype.createEmbeddedViewInternal = function (nodeIndex) {
        if ((nodeIndex == 1)) {
            return new View_AppComponent2(this.viewUtils, this, 1, this._anchor_1, this._vc_1);
        }
        return null;
    };
